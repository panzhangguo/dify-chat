		...
		<div>
			{list.map(item => {
				...
				return (
					<div
						key={item.id}
						className={`p-3 bg-(--theme-bg-color) mt-3 border border-solid border-gray-200 rounded-lg cursor-pointer hover:border-primary hover:text-primary ${isSelected ? 'text-primary border-primary bg-linear-to-r from-cyan-50 to-blue-50' : ''}`}
					>
