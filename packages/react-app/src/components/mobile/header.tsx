...
export const MobileHeader = (props: IMobileHeaderProps) => {
	...
	return (
		<div className="h-12 leading-[3rem]! px-4 text-base top-0 z-20 bg-(--theme-bg-color) w-full shadow-xs font-semibold justify-between flex items-center box-border">
			{mode === 'multiApp' ? (
				<Link
					to="/apps"
